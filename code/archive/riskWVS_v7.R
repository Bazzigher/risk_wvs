...
data6 = WV6_Data_v_2015_04_18[, c("V1", "V2","V70","V71","V72","V73","V74B","V75","V76","V77","V78","V79", "V240", "V242", "V248", "V229", "V57", "V58", "V262")]
...
countryfacts = read.csv("countryfacts_selection.csv", as.is = TRUE, header = TRUE) 
...
# age, sex 
model1 = lmer(risk ~ 1+scale(age)+factor(sex) + (1+scale(age)+factor(sex)|country),data = data)
