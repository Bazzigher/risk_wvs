...
# New code Laura (to compare with new code): Checking Log Transformation and Scaling/Reversing
```{r}
library(ggplot2)
...
# New code Laura (to compare with new code): Checking Effectiveness of Imputation Method
```{r}
