...
# Debug Plot
```{r}
# Überprüfung auf NA-Werte in den betreffenden Spalten
sum(is.na(mixed_model_data$age))
sum(is.na(mixed_model_data$risktaking))

# Entfernen von NA-Werten, falls vorhanden
mixed_model_data <- na.omit(mixed_model_data)
```


```{r}
summary(mixed_model_data$age)
summary(mixed_model_data$risktaking)
```
