...
# Plot GPS dataset individual countries 
```{r}
# Define the filename for the PDF
pdf("gps_individual_countries.pdf", width = 10, height = 8)  # Adjust width and height as needed

# Create a layout for all countries
par(mfrow = c(3, 3))  # Adjust the number of rows and columns as needed

# Loop over each country
for (country in unique(mixed_model_gps_data_new$country)) {
  # Subset data for the current country
  country_data <- subset(gps_data, country == country)
...
# Plot WVS dataset individual countries 
```{r}
# Define the filename for the PDF
pdf("gps_individual_countries.pdf", width = 10, height = 8)  # Adjust width and height as needed
...
# Loop over each country
for (country in unique(mixed_model_data_new$country)) {
  # Subset data for the current country
  country_data <- subset(mixed_model_data_new, country == country)
