...
plot(merged_data$age, merged_data$risktaking, las = 1, xaxt = "n", yaxt = "n", 
     ...
     main = "ALL", cex.main = 0.8, nrpoints = 0, col = "blue",
     xlim = c(min_age, max_age), ylim = c(35, 69), cex.lab = 0.6)

axis(1, at = c(min_age, 0, max_age), labels = c(min_age, 0, max_age), cex.axis = 0.7)
axis(2, at = c(35, 65), labels = c(35, 65), las = 1, cex.axis = 0.7, tck = -0.01, line = 0, mgp = c(3, 0.3, 0))
mtext("Age", 1, line = 0, cex = 0.5)
mtext(expression(Risk ~ Taking ~ (italic(T) - score)), 2, line = 1, cex = 0.5)
