...
results_model3 <- data.frame(
  Predictor = c("Intercept", "Age", "Gender", "Parental status", "Marital status", "Occupational status", "Education", "Hardship", "Hardship × Age", "Hardship × Gender"),
  Estimate = c(summary_model3$coefficients["(Intercept)", "Estimate"],
               ...
               summary_model3$coefficients["scale(z_score_age):hardship", "Estimate"], # Wechselwirkung zwischen Age und Hardship
               summary_model3$coefficients["factor(gender)1:hardship", "Estimate"]), # Wechselwirkung zwischen Gender und Hardship
  SE = c(summary_model3$coefficients["(Intercept)", "Std. Error"],
          ...
          summary_model3$coefficients["scale(z_score_age):hardship", "Std. Error"],
          summary_model3$coefficients["factor(gender)1:hardship", "Std. Error"]), 
  T_score = c(summary_model3$coefficients["(Intercept)", "t value"],
              ...
              summary_model3$coefficients["scale(z_score_age):hardship", "t value"],
              summary_model3$coefficients["factor(gender)1:hardship", "t value"]),
  p_value = c(summary_model3$coefficients["(Intercept)", "Pr(>|t|)"],
              ...
              summary_model3$coefficients["scale(z_score_age):hardship", "Pr(>|t|)"],
              summary_model3$coefficients["factor(gender)1:hardship", "Pr(>|t|)"])
)
