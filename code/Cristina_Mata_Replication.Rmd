...
plot.fit(regiondata$hardship,regiondata[,3],"hardship","scale(age)",regiondata$code2,coefs[2],c(-3,.5))
plot.fit(regiondata$hardship,regiondata[,4],"hardship","factor(sex)1",regiondata$code2,coefs[3],c(-5,0))
