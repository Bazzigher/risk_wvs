...
countryfacts <- countryfacts %>%
  mutate(
    ...
    alcusedis = scale(log(alcusedis)),
    anxietydis = scale(log(anxietydis)),
    adhd = scale(log(adhd)),
    autism = scale(log(autism)),
    bipolardis = scale(log(bipolardis)),
    conductdis = scale(log(conductdis)),
    depressdis = scale(log(depressdis)),
    drugusedis = scale(log(drugusedis)),
    eatingdis = scale(log(eatingdis)),
    hiv_aids_sextrasinf = scale(log(hiv_aids_sextrasinf)),
    ediopathicdevintdis = scale(log(ediopathicdevintdis)),
    mentaldis = scale(log(mentaldis)),
    Othermentaldis = scale(log(Othermentaldis)),
    schizophrenia = scale(log(schizophrenia)),
