...
countryfacts <- countryfacts %>%
  mutate(
    ...
    alcusedis = scale(alcusedis), 
    anxietydis = scale(anxietydis), 
    adhd = scale(adhd), 
    autism = scale(autism), 
    bipolardis = scale(bipolardis), 
    conductdis = scale(conductdis), 
    depressdis = scale(depressdis),
    drugusedis = scale(drugusedis), 
    eatingdis = scale(eatingdis), 
    hiv_aids_sextrasinf = scale(hiv_aids_sextrasinf), 
    idiopathicdevintdis = scale(ediopathicdevintdis), 
    mentaldis = scale(mentaldis), 
    othermentaldis = scale(othermentaldis), 
    schizophrenia = scale(schizophrenia), 
