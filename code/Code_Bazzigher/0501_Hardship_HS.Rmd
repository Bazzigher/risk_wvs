...
hardship_HS <- hardship_HS %>%
  ...
  rowwise() %>%
  mutate(
    hardship_HS = mean(c(HS_original_infantmortality, HS_original_genderequality, HS_original_lifeexpectancy,HS_alc_agelim, HS_sex_antiretroviral, HS_oth_cleancooking, HS_mh_mhhospit, HS_alc_tax_wine, HS_alc_roaddeath, HS_nic_affordability, HS_sex_gini, HS_drg_treatment, HS_mh_policy, HS_oth_obesity), na.rm = TRUE)
  ) %>%
  ungroup()
...
items <- hardship_HS %>%
  select(HS_original_infantmortality, HS_original_genderequality, HS_original_lifeexpectancy, 
         HS_alc_agelim, HS_alc_tax_wine, HS_alc_roaddeath, HS_drg_treatment, 
         HS_nic_affordability, HS_mh_policy, HS_sex_gini, HS_oth_obesity, 
         HS_oth_cleancooking, HS_mh_mhhospit, HS_sex_antiretroviral)

# ohne original-Variablen liegt Cronbachs Alpha bei .71
