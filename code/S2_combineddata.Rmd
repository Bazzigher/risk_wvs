...
for (page in 1:num_pages) {
  ...
  for (country in countries_on_page) {
    ...
    # Regression line für das aktuelle Land plotten
...
# Retrieve coefficients from the model2 output
```{r}
...
# Plot all countries combined Model2
```{r}
...
# Plot individual countries Model2
```{r}
countries_per_page <- 105  # Adjust to the actual number of plots per page
# Extrahiere einzigartige Länder aus dem Datensatz
all_countries <- unique(merged_data$country)
