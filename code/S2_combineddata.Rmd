...
plot <- ggplot(merged_data, aes(age_scale, risktaking, group = country, colour = country)) + 
...
ggsave(filename = "new_plot.pdf", plot = plot, width = 40, height = 40)  # Adjust width and height for better visibility
```
