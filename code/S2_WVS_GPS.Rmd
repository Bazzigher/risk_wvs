...
ggplot(merged, aes(x = Intercept_gps, y = Intercept_wvs)) +
  ...
  labs(title = "Comparison of Intercept Values",
       x = "Intercept Global Preference Study ",
...
ggplot(merged, aes(x = gender_gps, y = gender_wvs)) +
  ...
  labs(title = "Comparison of Gender Effect on Risk Taking",
       x = "Effect of Gender on Risk Taking Global Preference Study",
...
```{r}
ggplot(merged, aes(x = age_gps, y = age_wvs)) +
  geom_point(size = 1.5) +
  geom_smooth(method = "lm", se = FALSE, linetype = "dashed") +
  labs(title = "Comparison of Age Effect on Risk Taking",
       x = "Effect of Age on Risk Taking Global Preference Study",
...
correlation_intercept <- cor(merged$Intercept_gps, merged$Intercept_wvs)

correlation_age <- cor(merged$age_gps, merged$gender_wvs)

correlation_gender <- cor(merged$gender_gps, merged$gender_wvs)
